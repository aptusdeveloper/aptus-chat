 ...
 * @param {Object} options - Optional presentation settings, such as duration.
 */
export const useAlert = (message, action = null, options = {}) => {
  emitter.emit('newToastMessage', { message, action, ...options });
};
