export default {
  ...
  SET_CRM_PIPELINES: 'SET_CRM_PIPELINES',
  SET_CRM_DEALS: 'SET_CRM_DEALS',
  SET_CRM_ACTIVE_PIPELINE: 'SET_CRM_ACTIVE_PIPELINE',
  SET_CRM_UI_FLAG: 'SET_CRM_UI_FLAG',
  UPSERT_CRM_DEAL: 'UPSERT_CRM_DEAL',
  DELETE_CRM_DEAL: 'DELETE_CRM_DEAL',
  UPSERT_CRM_PIPELINE: 'UPSERT_CRM_PIPELINE',
  DELETE_CRM_PIPELINE: 'DELETE_CRM_PIPELINE',
  UPSERT_CRM_STAGE: 'UPSERT_CRM_STAGE',
  DELETE_CRM_STAGE: 'DELETE_CRM_STAGE',
  SET_CRM_AUTOMATION_UI_FLAG: 'SET_CRM_AUTOMATION_UI_FLAG',
  SET_CRM_AUTOMATIONS: 'SET_CRM_AUTOMATIONS',
  UPSERT_CRM_AUTOMATION: 'UPSERT_CRM_AUTOMATION',
  DELETE_CRM_AUTOMATION: 'DELETE_CRM_AUTOMATION',

  SET_AGENDA_UI_FLAG: 'SET_AGENDA_UI_FLAG',
  SET_AGENDA_PROFESSIONALS: 'SET_AGENDA_PROFESSIONALS',
  UPSERT_AGENDA_PROFESSIONAL: 'UPSERT_AGENDA_PROFESSIONAL',
  DELETE_AGENDA_PROFESSIONAL: 'DELETE_AGENDA_PROFESSIONAL',
  SET_AGENDA_EVENT_TYPES: 'SET_AGENDA_EVENT_TYPES',
  UPSERT_AGENDA_EVENT_TYPE: 'UPSERT_AGENDA_EVENT_TYPE',
  DELETE_AGENDA_EVENT_TYPE: 'DELETE_AGENDA_EVENT_TYPE',
  SET_AGENDA_APPOINTMENTS: 'SET_AGENDA_APPOINTMENTS',
  UPSERT_AGENDA_APPOINTMENT: 'UPSERT_AGENDA_APPOINTMENT',
  SET_AGENDA_AVAILABILITIES: 'SET_AGENDA_AVAILABILITIES',
  UPSERT_AGENDA_AVAILABILITY: 'UPSERT_AGENDA_AVAILABILITY',
  DELETE_AGENDA_AVAILABILITY: 'DELETE_AGENDA_AVAILABILITY',
};
