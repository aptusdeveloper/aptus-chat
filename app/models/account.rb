...
class Account < ApplicationRecord
  ...
  store_accessor :custom_attributes, :aptus_hub
  include AccountCaptainAutoResolve

  has_many :account_users, dependent: :destroy_async
  has_many :agenda_professionals, dependent: :destroy_async
  has_many :agenda_event_types, dependent: :destroy_async
  has_many :agenda_appointments, dependent: :destroy_async
  ...
  after_create_commit :setup_crm_default_pipeline
  ...
  def setup_crm_default_pipeline
    Crm::DefaultPipelineSetupService.new(self).perform
  end
