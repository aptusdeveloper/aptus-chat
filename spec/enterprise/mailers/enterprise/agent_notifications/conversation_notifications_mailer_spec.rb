...
RSpec.describe AgentNotifications::ConversationNotificationsMailer, type: :mailer do
  ...
  describe 'sla_missed_first_response' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq("A conversa [ID - #{conversation.display_id}] excedeu o SLA da primeira resposta")
    end
  ...
  describe 'sla_missed_next_response' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq("A conversa [ID - #{conversation.display_id}] excedeu o SLA da próxima resposta")
    end
  ...
  describe 'sla_missed_resolution' do
    ...
    it 'renders the subject' do
      expect(mail.subject).to eq("A conversa [ID - #{conversation.display_id}] excedeu o SLA do tempo de resolução")
    end
